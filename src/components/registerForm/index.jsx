    ...
    <div className="card shadow-lg p-8 rounded-lg border-1 border-[#A084E8] backdrop-blur-md bg-white bg-opacity-20 dark:bg-opacity-50">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="card-body">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-black text-center mb-4">
            Register
          </h2>
          <div className="form-control">
            <label className="label">
              <span className="label-text !text-[#c0a7eb] font-bold">
                Email
              </span>
            </label>
            <input
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text !text-[#c0a7eb] font-bold mr-2">
                Confirm Password
              </span>
            </label>
            <input
